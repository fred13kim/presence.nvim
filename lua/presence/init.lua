...
function Presence:setup(...)
    ...
    self:set_option("custom_image", false)
...
function Presence:update_for_buffer(buffer, should_debounce)
    ...
    local use_file_as_custom_image = self.options.custom_image
    local assets = {
        large_image = use_file_as_custom_image or (use_file_as_main_image and asset_key or "neovim"),
